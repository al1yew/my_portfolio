      ...
      <div className=" all">
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 left">
          ...
          <p>
            ...
            Join me on this exciting journey as we build remarkable software
            solutions together.
          </p>
          <div className="bottom col-lg-12 col-12 col-md-12">
            ...
            <div className="icons col-lg-5-5 col-5-5 col-md-5-5">
              ...
              <span>
                <a
                  href="https://www.linkedin.com/in/aliyev-vasif/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaLinkedinIn />
              ...
              <span>
                <a href="mailto:vasifaliyev.work@gmail.com" target="_blank">
                  <FiMail />
                </a>
              </span>
            </div>
